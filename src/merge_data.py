...
class MergeData:
	...
	def merge_data(self):
		...
		# Try to find date and close columns intelligently
		...
		# Set the class dataframe so it's accessible in the pipeline
